...
4. Ser escrita obrigatoriamente em:
    Se sua vaga é para Ruby e Ruby On Rails : Ruby 2.1+ Rails 4 e SQLite
    Se sua vaga é para .Net : VB# ou C#, última versão, SQL Server (pode ser express)
